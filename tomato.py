...
class Tomato:
    ...
    def draw_contours_on_frame(self, frame):
        ...
        for i, contour in enumerate(contours):
            ...
            if area > 30:  # Lọc theo diện tích
                ...
                cv2.rectangle(output_image, (x, y), (x + w, y + h), (0,0,128), 2)
                ...
                cv2.circle(output_image, (center_x, center_y), 5, (0,0,128), -1)
                ...
                # Ghi diện tích của đối tượng trên hộp
                
                cv2.putText(output_image, "TOMATO", (x, y + h + 15), cv2.FONT_HERSHEY_SIMPLEX, 0.4, (0,0,128), 1)

                # Thêm điểm trung tâm vào danh sách
                center_points.append((center_x, center_y))

        self.So_luong_tomato = len(center_points)  # Ghi lại số lượng tomato
    ...
    def read_and_display(self,frame):
        ...
        while True:
            ...
            elif key == ord('r'):  # Lọc màu đỏ
                self.color_filter = 'red'
